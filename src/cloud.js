...
Cloud.prototype.knownDomains = {
    'Programovani pro děti Cloud' : 'https://cloud.snap.programovaniprodeti.cz'
};

Cloud.prototype.defaultDomain = Cloud.prototype.knownDomains['Programovani pro děti Cloud'];
